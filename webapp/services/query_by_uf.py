...
#Filtra o dataframe por UF (derivados) e retorna o mesmo
def query_by_uf_combs(uf : str) -> List[dict]:
    ...
    if df.empty:
        return {'Message' : 'UF não encontrado.'}
    return df.to_dict(orient='records')


#Filtra o dataframe por UF (derivados) e retorna o mesmo
def query_by_uf_diesel(uf : str) -> List[dict]:
